...
pub fn build(b: *std.Build) void {
    ...
    // test only module linearalgebra
    const linearalgebra_test_f32 = b.createModule(.{
        .root_source_file = b.path("src/linearalgebra_test_f32.zig"),
        .target = target,
        .optimize = optimize,
        .imports = &.{
            .{ .name = "linearalgebra", .module = mod_linearalgebra },
    ...
    const linearalgebra_test_vector = b.createModule(.{
        .root_source_file = b.path("src/linearalgebra_test_vector.zig"),
        .target = target,
        .optimize = optimize,
        .imports = &.{
            .{ .name = "linearalgebra", .module = mod_linearalgebra },
    ...
    const mods = [_]*std.Build.Module{
        mod_linearalgebra,
        linearalgebra_test_f32,
        linearalgebra_test_vector,
        mod_simplex,
        mod_main,
        exe.root_module,
    };
